...
#include <gazebo/gazebo.hh> // Used to be <gazebo.hh>
...
{   
  class SetJointsTimed : public ModelPlugin
  {
    public: void Load(physics::ModelPtr _parent, sdf::ElementPtr /*_sdf*/) 
    {
      ...
      this->updateConnection = event::Events::ConnectWorldUpdateBegin(boost::bind(&SetJointsTimed::OnUpdate, this, _1));
	...
	std::cout << "\n Gazebo found the joint coordinate list file at " << path_to_joint_coord_file << std::endl;
      ...
      {
	std::cout << "\n Gazebo failed to find the joint coordinate list file. There should be a file named forGazebo consisting of 7 CSVs per line in the \"WAM Model\" folder."
