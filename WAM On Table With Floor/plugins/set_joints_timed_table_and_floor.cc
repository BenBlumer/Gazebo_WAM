...
namespace gazebo
{   
  class SetJointsTimedTableAndFloor: public ModelPlugin
  {
    public: void Load(physics::ModelPtr _parent, sdf::ElementPtr /*_sdf*/) 
    {
      ...
      this->updateConnection = event::Events::ConnectWorldUpdateBegin(boost::bind(&SetJointsTimedTableAndFloor::OnUpdate, this, _1));
      std::ifstream joint_coordinate_commands;
      std::string path_to_joint_coord_file =  common::SystemPaths::Instance()->FindFileURI("model://WAM On Table With Floor/forGazebo");
  ...
  GZ_REGISTER_MODEL_PLUGIN(SetJointsTimedTableAndFloor)
}
